  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-[70vh] dark:bg-slate-950 bg-slate-950 relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-full px-4 flex flex-col justify-center">
        ...
        >
          <p className="text-cyan-400 font-medium text-sm tracking-widest uppercase mb-4">Our Services</p>
          <h2 className="text-center text-4xl md:text-6xl font-bold text-white">
            We provide services worldwide
          </h2>
          <p className="text-center text-base md:text-lg font-normal text-slate-300 max-w-2xl mt-4 mx-auto">
